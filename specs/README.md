...
| SPEC-0003 | [Finalização durável, contexto e mídia](0003-durable-finalization-and-media.md) | Baseline ativo v1.4 | P0/P1 | SPEC-0001, SPEC-0002 | Ciclo persistente único, contexto, mídia, retry e recuperação concorrente; limites persistidos consumidos por roteamento. |
...
| SPEC-0011 | [Criação durável de Request Acessórias](0011-durable-acessorias-request-creation.md) | Implementado localmente v1.1; issues 0017–0019 | P1 / Milestone E | SPEC-0001, SPEC-0003, SPEC-0007–0010 | Criação multipart externa (`tipo=E`) durável, com limite Sliding Window compartilhado no processo, sem idempotency key do provider, retry conservador somente sob prova de pré-envio e reconciliação manual. |

A evidência mais recente registrada para SPEC-0004 é **197 passed, 64 skipped**
na etapa offline e **64 passed, 197 deselected** na etapa PostgreSQL
descartável (issue 0020). A evidência anterior de issue 0024 foi **193 passed,
...
avanço. SPEC-0010 v1.2 tem sua governança inicial aprovada e foi implementada
...
cada avaliação fica limitada aos limites persistidos do ciclo. SPEC-0011 v1.1 tem
contrato Request e políticas de duplicidade, retry e reconciliação implementados
pelos issues 0017–0019; a migration `0019` e a operação durável preservam a
...
3. Build implementa issues aprovadas, executa a verificação exigida e atualiza o status da especificação com evidência. O isolamento da suíte (issue 0001), o runner descartável (0002), a verificação operacional (0004), a remoção das superfícies de diagnóstico (0006), a reconciliação documental (0007 e 0009), a publicação de SPEC-0006 (0008), o Milestone A de SPEC-0007 (0012), o Milestone B de SPEC-0008 (0013 e 0014), o Milestone C de SPEC-0009 (0015) e o Milestone D de SPEC-0010 (0016 e 0020) estão implementados.
