...
| --- | --- | --- | --- | --- | --- |
| SPEC-0001 | [Contrato compartilhado de dados e análise](0001-shared-data-and-analysis-contract.md) | Baseline ativo v1.4; boundary estrutural 0032 | P0 / baseline | — | Fonte durável, integridade, contrato IA, migrações e fronteiras de privacidade. |
...
A evidência mais recente registrada para SPEC-0004 é **218 passed, 69 skipped**
na etapa offline e **69 passed, 218 deselected** na etapa PostgreSQL
descartável (issue 0032). A evidência anterior de issue 0031 foi **216 passed,
