...
| SPEC-0004 | [Baseline reprodutível de testes e verificação](0004-reproducible-verification-baseline.md) | Pronto para issues v1.1 | P0 / fase 0 | SPEC-0001–0003 | Suíte rastreada, isolamento, runner descartável e evidência de release. |
...
3. Build implementa issues aprovadas, executa a verificação exigida e atualiza o status da especificação com evidência.
